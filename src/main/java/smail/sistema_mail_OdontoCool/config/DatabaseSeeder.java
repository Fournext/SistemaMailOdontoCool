...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    //seed para cargar el catalogo de dientes, se verifica si el diente con el numero ya existe para evitar duplicados
    ...
    //analisis, se verifica si el analisis con el nombre ya existe para evitar duplicados
    ...
    private void seedServiciosConPrecios() {
        crearServicioConPrecio("Consulta odontológica general", "Evaluación inicial del estado bucal del paciente.", "Consulta", "BOB", "80");
        crearServicioConPrecio("Limpieza dental", "Profilaxis dental para remover placa bacteriana y sarro.", "Preventivo", "BOB", "150");
        crearServicioConPrecio("Aplicación de flúor", "Tratamiento preventivo para fortalecer el esmalte dental.", "Preventivo", "BOB", "100");
        crearServicioConPrecio("Sellantes dentales", "Aplicación de sellantes para prevenir caries.", "Preventivo", "BOB", "120");
        crearServicioConPrecio("Restauración dental", "Curación de caries con resina u otro material.", "Operatoria", "BOB", "180");
        crearServicioConPrecio("Extracción dental simple", "Extracción de una pieza dental sin cirugía compleja.", "Cirugía", "BOB", "200");
        crearServicioConPrecio("Extracción de tercer molar", "Extracción de muela del juicio.", "Cirugía", "BOB", "450");
        crearServicioConPrecio("Endodoncia", "Tratamiento de conductos radiculares.", "Endodoncia", "BOB", "500");
        crearServicioConPrecio("Blanqueamiento dental", "Procedimiento estético para aclarar dientes.", "Estética", "BOB", "700");
        crearServicioConPrecio("Ortodoncia", "Tratamiento para corregir la posición dental.", "Ortodoncia", "BOB", "2500");
        crearServicioConPrecio("Control de ortodoncia", "Revisión y ajuste periódico de ortodoncia.", "Ortodoncia", "BOB", "150");
        crearServicioConPrecio("Periodoncia", "Tratamiento de encías y tejidos de soporte dental.", "Periodoncia", "BOB", "300");
        crearServicioConPrecio("Raspado y alisado radicular", "Limpieza profunda debajo de la encía.", "Periodoncia", "BOB", "350");
        crearServicioConPrecio("Prótesis dental", "Rehabilitación mediante prótesis removible o fija.", "Rehabilitación", "BOB", "1200");
        crearServicioConPrecio("Corona dental", "Restauración fija que cubre una pieza dental dañada.", "Rehabilitación", "BOB", "900");
        crearServicioConPrecio("Implante dental", "Reemplazo de una pieza dental mediante implante.", "Implantología", "BOB", "5000");
        crearServicioConPrecio("Radiografía dental", "Estudio radiográfico para diagnóstico odontológico.", "Diagnóstico", "BOB", "100");
        crearServicioConPrecio("Urgencia odontológica", "Atención inmediata por dolor, inflamación o traumatismo dental.", "Urgencia", "BOB", "120");

        System.out.println("====== SEED EXITOSO: Servicios con precios cargados ======");
    }

    private void crearServicioConPrecio(String nombre, String descripcion, String tipo, String moneda, String montoTexto) {
